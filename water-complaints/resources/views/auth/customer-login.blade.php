...
<body class="flex items-center justify-center min-h-screen">
    <div class="login-container w-full max-w-md">
        <div class="login-form">
            <h1 class="text-3xl font-bold text-center text-blue-700 mb-2">Customer Login</h1>
            <p class="text-center text-gray-600 mb-6">Please log in as a Customer to continue.</p>
