...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="bg-blue-500 rounded-xl shadow-lg p-6 border-l-4 border-blue-700 hover:shadow-xl transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-white">Total Complaints</p>
            ...
            <div class="bg-yellow-500 rounded-xl shadow-lg p-6 border-l-4 border-yellow-700 hover:shadow-xl transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <div class="bg-orange-500 rounded-xl shadow-lg p-6 border-l-4 border-orange-700 hover:shadow-xl transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-white">In Progress</p>
            ...
            <div class="bg-green-500 rounded-xl shadow-lg p-6 border-l-4 border-green-700 hover:shadow-xl transition-shadow">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-white">Resolved</p>
